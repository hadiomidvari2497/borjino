...
$breadcrumbs = [
    ...
    ['label' => $building['name'] ?? 'ساختمان', 'href' => '/buildings/'.$building['id']],
    ['label' => 'ویرایش', 'href' => '/buildings/'.$building['id'].'/edit']
];
$currentRoute = '/buildings';

$pageActions = '
<a href="/buildings/'.$building['id'].'" class="btn btn-secondary">
...
$formAction = '/buildings/'.$building['id'];
$formMethod = 'POST';
...
<div class="grid grid-2" style="gap: 1.5rem;">
    ...
    <div class="card" style="grid-column: 1 / -1;">
        ...
        <div class="card-body">
            '.formActionButtons([
                ['label' => 'به‌روزرسانی ساختمان', 'type' => 'submit', 'class' => 'btn btn-primary'],
                ['label' => 'انصراف', 'href' => '/buildings/'.$building['id'], 'class' => 'btn btn-secondary'],
            ]).'
        </div>
    </div>
</div>
